        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container my-5">
                    ...
                    <div class="card-body">
                        <h4 class="mb-4">Form Edit data Supplier</h4>
                        <form action="<?= base_url('edit_data_supplier/' . $data['nama_penyedia']) ?>" method="POST">
                            <?= csrf_field() ?>
                            <div class="mb-3">
                                <label for="nama_penyedia" class="form-label">Nama Supplier</label>
                                <input type="text" class="form-control" id="nama_penyedia" value="<?= $data['nama_penyedia'] ?>" name="nama_penyedia" required>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" value="<?= $data['catatan'] ?>" id="catatan" name="catatan">
                                </div>
                            </div>
