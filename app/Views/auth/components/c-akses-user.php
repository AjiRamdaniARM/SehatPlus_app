    ...
    <div class="row w-100">
       <!-- === component all button akses === -->
        <div class="col-lg-6 d-flex flex-column justify-content-center gap-5">
            <button class="btn bg-blue-1 text-white d-flex align-items-center gap-2 p-5">
                <i class="bi bi-person-badge"></i> Admin
            </button>
            <button class="btn bg-green-1 text-white d-flex align-items-center gap-2 p-5">
                <i class="bi bi-cash-stack"></i> Kasir
            </button>
            <button class="btn btn-warning d-flex align-items-center gap-2 p-5">
